...
public:
    ...
    // todo rename, get rid of mark_group_committed_request
    auto mark_group_committed(mark_group_committed_request&& request) {
        return route(std::move(request), &group_manager::mark_group_committed);
    }
