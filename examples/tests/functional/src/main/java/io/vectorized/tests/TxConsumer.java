...
public class TxConsumer 
{
    ...
    public TxConsumer(String connection, String topic, boolean isReadCommittedIsolation) {
        this.topic = topic;
    ...
    public List<TxRecord> read(long start_offset, long last_offset, int batchSize) throws Exception {
        ...
        throw new Exception("can't read up to " + last_offset + " in " + limit + " tries");
    }

    public List<TxRecord> readN(long start_offset, int n, int batchSize) throws Exception {
        List<TxRecord> result = new ArrayList<>();
        var limit = n * 10;
