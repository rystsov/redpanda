...
public class TxStream 
{
    ...
    public TxStream(String connection) {
    ...
    public void initConsumer(String topic, String groupId, boolean isReadCommittedIsolation) {
        this.topic = topic;
    ...
    public long commitTx(String topic, String key, String value) throws Exception {
    ...
    public Map<Long, Long> process(long end, Function<String, String> transform, int batchSize, String target_topic) throws Exception {
        Map<TopicPartition, OffsetAndMetadata> offsets;
        ...
        while (true) {
            ...
            while (it.hasNext()) {
                ...
                producer.beginTransaction();
                var future = producer.send(new ProducerRecord<String, String>(target_topic, key, transform.apply(value)));
