...
public class BaseSendBench extends Consts 
{
    public Producer<String, String> producer;

    public BaseSendBench(String connection, String txId) {
    ...
    {
        var bench = new BaseSendBench(getConnection(), "my-tx-1");
        bench.warmup("topic1", "topic2", getWarmupTxes(100));
