...
public class BaseStreamBench extends Consts 
{
    String connection;
    ...
    public BaseStreamBench(String connection, String source_topic, String target_topic) {
    ...
    void warmup(int iterations, int batchSize) throws Exception {
        ...
        while (count < iterations) {
            ...
            while (it.hasNext()) {
                ...
                var f1 = producer.send(new ProducerRecord<String, String>(target_topic, key, value.toUpperCase()));
    ...
    {
        var bench = new BaseStreamBench(getConnection(), "topic1", "topic2");
        ...
        bench.warmup(getWarmupTxes(100), 10);
        bench.consumer.close();
        
        bench.initConsumer("groupId");
        //bench.setGroupStartOffset(offset);
        bench.measure(getTxes(1000), 10);
        bench.consumer.close();
    }
}
