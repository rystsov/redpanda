...
public class TxSendOffsetsBench 
{
    ...
    public TxSendOffsetsBench(String connection, String topic) {
    ...
    void warmup(int iterations) throws Exception {
    ...
    {
        var bench = new TxSendOffsetsBench("172.31.31.154:9092", "topic1");
